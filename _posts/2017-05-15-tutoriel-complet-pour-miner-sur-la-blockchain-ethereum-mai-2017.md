...
<em>Nouvelle mise à jour partielle le 06.04.2018.</em>
...
<em>[Edit 06.04.2018] : Il faut maintenant au moins 156 jours avec 6 GTX1060 pour obtenir 1ETH.</em>
...
La limite de 3GB sera dépassée à la fin Avril 2019
...
<em>[Edit 06.04.2018] Suite à plusieurs questions sur le sujet : le solde affiché sur la page du pool n'est pas directement transféré sur votre wallet personnel. Il faut atteindre le seuil fixé pour déclencher le paiement, moyennant un petit fee (taxe). Ce seuil est bien souvent modifiable. Attention, en réglant trop bas le seuil de paiement, les pools imposent en général des fees fixes, donc au final vous vous faites plus taxer ! Cela s'explique en partie par le fait que chaque transaction a un coût sur la blockchain qui ne dépend pas du montant transféré (pour éviter une attaque de type "spam de milliards de micro-transactions pour saturer inutilement la blockchain").</em>
